var COMMON_TOOLS = {
     ...
     * @param {Object} type 类型：1-所有空格  2-前后空格  3-前空格 4-后空格
     * @example
     *  trim('  1235asd',1)
     *  result：1235asd
     */
     ...
     * 字母大小写转换
     * @param {Object} str 字符串
     * @param {Object} type 类型：1: 首字母大写     2：首字母小写 3：大小写转换 4：全部大写  5：全部小写
     * @example
     *  changeCase('asdasd',1)
     *  result：Asdasd
     */
     ...
     * @param {Object} AFindText 要替换的字符或者正则表达式（不要写g）
     * @param {Object} ARepText 替换成什么
     * @example
     ...
     * 字符替换为 *
     * @param {Object} str 原字符串
     * @param {Object} regArr 字符格式
     * @param {Object} type 替换方式
     * @param {Object} ARepText 替换的字符（默认*）
     * @example
     ...
     * @param {Object} str 字符串
     * @param {Object} type 替换内容 special-特殊字符,html-html标签,emjoy-emjoy表情,word-小写字母，WORD-大写字母，number-数字,chinese-中文），，默认'',保留哪些特殊字符
     * @param {Object} restr 要替换成什么,默认''
     * @param {Object} spstr 保留哪些特殊字符
     * @example
     ...
     * 格式化处理字符串
     * @param {Object} str 字符串
     * @param {Object} size 默认为3
     * @param {Object} delimiter 分隔符，默认为逗号
     * @example
     ...
     * 找出最长单词
     * @param {Object} str 字符串
     * @param {Object} splitType 分隔符,默认为空格
     * @example 
     ...
     * @param {Object} arr 数组/字符串
     * @param {Object} rank 长度，默认为数组长度
     * @param {Object} ranktype 排序方式，默认降序
     * @example
     ...
     * 筛选数组
     * @param {Object} arr 数组
     * @param {Object} val 筛选条件
     * @param {Object} type 筛选类型
     * @example
     *  删除值为'val'的数组元素
    ...
    /**
     * 图片滚动懒加载
     * @param {Object} className {string} 要遍历图片的类名
     * @param {Object} num {number} 距离多少的时候开始加载 默认 0，
     *  比如，一张图片距离文档顶部3000，num参数设置200，那么在页面滚动到2800的时候，图片加载。
     * 不传num参数就滚动，num默认是0，页面滚动到3000就加载
     * @param {Object} errorUrl 图片加载失败时显示的替代图片url
     * @example
     *  html代码
     *  <p><img data-src="1.jpg" class="load-img" width='528' height='304' /></p>
     *  <p><img data-src="2.jpg" class="load-img" width='528' height='304' /></p>
     *  <p><img data-src="3.jpg" class="load-img" width='528' height='304' /></p>....
